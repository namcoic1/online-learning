                        ...
                        <div class="w-25">
                            ...
                            <div class="mt-2"><h6 style="color: blue">Question Status</h6>
                                <input title="Click to filter by status" type="checkbox" name="status" value="0"
                                       ${qsta[0]?"checked" : ""} onclick="this.form.submit()">&nbsp;&nbsp;Not Done<br/> 
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <c:forEach items="${listQues}" var="list">
                                            <tr>
                                                ...
                                                <td>${list.sname}</td>
                                                <td>${list.qname}</td>
                                                <c:if test="${list.ques_status == 0}">
                                                    <td style="color: red; font-weight: bold">Customer haven't done before</td>   
                                                </c:if>
                                                <c:if test="${list.ques_status != 0}">
                                                    <td style="color: blue; font-weight: bold">Customer have done</td>   
                                                </c:if>
                                                <td>
